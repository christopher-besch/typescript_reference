...
// simple shapes //
///////////////////
let ctx_00: CanvasRenderingContext2D = get_ctx("canvas_00");
...
// path //
//////////
let ctx_01: CanvasRenderingContext2D = get_ctx("canvas_01");
...
// images //
////////////
let ctx_02: CanvasRenderingContext2D = get_ctx("canvas_02");
...
let image_00: HTMLImageElement = new Image();
...
///////////////////////////////
let ctx_03: CanvasRenderingContext2D = get_ctx("canvas_03");
...
image_01.onload = function () {
    ...
    ctx_03.drawImage(
        ...
        0,
        0,
        image_01.naturalWidth / 2,
        image_01.naturalHeight / 2,
        10,
        10,
        200,
        200
...
image_02.onload = function () {
    ...
    let pattern: CanvasPattern = ctx_03.createPattern(
